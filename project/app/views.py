...
def output(request):
    ...
    table = open("C:/Users/harsh/PycharmProjects/Assignment5-master/project/app/templates/output1.html", "w")
    table.write(b)
    table.close()

    table = open("C:/Users/harsh/PycharmProjects/Assignment5-master/project/app/templates/output1.html", "a")
    table.write('<form method="get" action="project/Pivot_Data.xlsx"><button type="submit">Download!</button></form>')
    table.close()
